...
public class AddVideoActivity extends AppCompatActivity implements ProgressRequestBody.UploadCallbacks,SelectableCategoryViewHolder.OnItemSelectedListener ,SelectableLanguageViewHolder.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle(R.string.new_video);
    ...
    private void SelectImage() {
        if (ContextCompat.checkSelfPermission(AddVideoActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(AddVideoActivity.this, new String[] { Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE }, 0);
        }else{
    ...
    public void checkPermission(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (ContextCompat.checkSelfPermission(AddVideoActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)  != PackageManager.PERMISSION_GRANTED) {
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(AddVideoActivity.this,   Manifest.permission.READ_CONTACTS)) {
    ...
    private void initView() {
        ...
        pd = new ProgressDialog(AddVideoActivity.this);
        ...
        findViewById(R.id.action_insert_image).setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                ...
                final EditText input = new EditText(AddVideoActivity.this);
        ...
        findViewById(R.id.action_insert_link).setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                ...
                final EditText one = new EditText(AddVideoActivity.this);
                final EditText two = new EditText(AddVideoActivity.this);

                one.setHint("Text");
                two.setHint("URL");

                LinearLayout lay = new LinearLayout(AddVideoActivity.this);
    ...
    public boolean save(){
        if (edit_text_upload_title.getText().toString().trim().length()<3){
            Toasty.error(AddVideoActivity.this, getResources().getString(R.string.edit_text_upload_title_error), Toast.LENGTH_SHORT).show();
            return true;
        }
        if (edit_text_upload_description.getHtml() != null){
            if (edit_text_upload_description.getHtml().toString().trim().length()<10){
                Toasty.error(AddVideoActivity.this, getResources().getString(R.string.edit_text_upload_description_error), Toast.LENGTH_SHORT).show();
                return true;
            }
        }else{
            Toasty.error(AddVideoActivity.this, getResources().getString(R.string.edit_text_upload_description_error), Toast.LENGTH_SHORT).show();
        ...
        if (imageUrl==null){
            Toasty.error(AddVideoActivity.this, getResources().getString(R.string.image_upload_error), Toast.LENGTH_SHORT).show();
            return true;
        }
        ...
        call.enqueue(new Callback<List<Category>>() {
            ...
            public void onResponse(Call<List<Category>> call, Response<List<Category>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    categorySelectAdapter = new CategorySelectAdapter(AddVideoActivity.this, categoriesListObj, true, AddVideoActivity.this);
        ...
        call.enqueue(new Callback<List<Language>>() {
            ...
            public void onResponse(Call<List<Language>> call, Response<List<Language>> response) {
                if(response.isSuccessful()) {
                    ...
                    ArrayAdapter adapter = new ArrayAdapter(AddVideoActivity.this, R.layout.my_spinner_dropdown_item, contactlist);
    ...
    public void upload(){
        ...
        File file_video = new File(videoUrl);
        int file_size_video = Integer.parseInt(String.valueOf(file1.length()/1024/1024));
        if (file_size_video>100){
            Toasty.error(getApplicationContext(),"Max file size allowed 100M",Toast.LENGTH_LONG).show();
        }
        ...
        ProgressRequestBody requestFile = new ProgressRequestBody(file, AddVideoActivity.this);
        ProgressRequestBody requestFile_video = new ProgressRequestBody(file_video, AddVideoActivity.this);
        ...
        MultipartBody.Part bodyvideo =MultipartBody.Part.createFormData("uploaded_file_video", file_video.getName(), requestFile_video);

        String id_ser=  prf.getString("ID_USER");
        String key_ser=  prf.getString("TOKEN_USER");

        Call<ApiResponse> request = service.uploadVideo(body,bodyvideo, id_ser, key_ser, edit_text_upload_title.getText().toString().trim(),edit_text_upload_description.getHtml().toString().trim(),languageList.get(spinner_language_select.getSelectedItemPosition()).getId().toString(),getSelectedCategories());
