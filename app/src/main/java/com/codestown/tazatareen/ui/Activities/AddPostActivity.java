...
public class AddPostActivity extends AppCompatActivity implements ProgressRequestBody.UploadCallbacks,SelectableCategoryViewHolder.OnItemSelectedListener ,SelectableLanguageViewHolder.OnItemSelectedListener {
    ...
    private void SelectImage() {
        if (ContextCompat.checkSelfPermission(AddPostActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(AddPostActivity.this, new String[] { Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE }, 0);
        }else{
    ...
    public void checkPermission(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (ContextCompat.checkSelfPermission(AddPostActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)  != PackageManager.PERMISSION_GRANTED) {
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(AddPostActivity.this,   Manifest.permission.READ_CONTACTS)) {
      ...
      final RichEditor mEditor = (RichEditor) findViewById(R.id.editor);
        ...
        findViewById(R.id.action_insert_image).setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                ...
                final EditText input = new EditText(AddPostActivity.this);
        ...
        findViewById(R.id.action_insert_link).setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                ...
                final EditText one = new EditText(AddPostActivity.this);
                final EditText two = new EditText(AddPostActivity.this);

                one.setHint("Text");
                two.setHint("URL");

                LinearLayout lay = new LinearLayout(AddPostActivity.this);
    ...
    public boolean save(){
        if (edit_text_upload_title.getText().toString().trim().length()<3){
            Toasty.error(AddPostActivity.this, getResources().getString(R.string.edit_text_upload_title_error), Toast.LENGTH_SHORT).show();
            return true;
        }
        if (edit_text_upload_description.getHtml() != null){
            if (edit_text_upload_description.getHtml().toString().trim().length()<10){
                Toasty.error(AddPostActivity.this, getResources().getString(R.string.edit_text_upload_description_error), Toast.LENGTH_SHORT).show();
                return true;
            }
        }else{
            Toasty.error(AddPostActivity.this, getResources().getString(R.string.edit_text_upload_description_error), Toast.LENGTH_SHORT).show();
        ...
        if (imageUrl==null){
            Toasty.error(AddPostActivity.this, getResources().getString(R.string.image_upload_error), Toast.LENGTH_SHORT).show();
            return true;
        }
    ...
    private void initAction() {
        ...
        image_view_done_rich.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                web_view_post_activity_content.loadData(content,"text/html; charset=utf-8", "utf-8");
        ...
        call.enqueue(new Callback<List<Category>>() {
            ...
            public void onResponse(Call<List<Category>> call, Response<List<Category>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    categorySelectAdapter = new CategorySelectAdapter(AddPostActivity.this, categoriesListObj, true, AddPostActivity.this);
        ...
        call.enqueue(new Callback<List<Language>>() {
            ...
            public void onResponse(Call<List<Language>> call, Response<List<Language>> response) {
                if(response.isSuccessful()) {
                    ...
                    ArrayAdapter adapter = new ArrayAdapter(AddPostActivity.this, R.layout.my_spinner_dropdown_item, contactlist);
    ...
    public void upload(){
        ...
        ProgressRequestBody requestFile = new ProgressRequestBody(file, AddPostActivity.this);
        ...
        Call<ApiResponse> request = service.uploadPost(body, id_ser, key_ser, edit_text_upload_title.getText().toString().trim(),edit_text_upload_description.getHtml().toString().trim(),languageList.get(spinner_language_select.getSelectedItemPosition()).getId().toString(),getSelectedCategories());
