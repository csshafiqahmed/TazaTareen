...
public class EditYoutubeActivity extends AppCompatActivity implements ProgressRequestBody.UploadCallbacks,SelectableCategoryViewHolder.OnItemSelectedListener ,SelectableLanguageViewHolder.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.youtube =  bundle.getString("youtube");
        ...
        toolbar.setTitle(R.string.edit_youtube_video);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    }
    private void setPost() {
        edit_text_upload_title.setText(title);
        edit_text_upload_youtube.setText(youtube);
    ...
    private void SelectImage() {
        if (ContextCompat.checkSelfPermission(EditYoutubeActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(EditYoutubeActivity.this, new String[] { Manifest.permission.CAMERA, Manifest.permission.WRITE_EXTERNAL_STORAGE }, 0);
        }else{
    ...
    public void checkPermission(){
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (ContextCompat.checkSelfPermission(EditYoutubeActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)  != PackageManager.PERMISSION_GRANTED) {
                ...
                if (ActivityCompat.shouldShowRequestPermissionRationale(EditYoutubeActivity.this,   Manifest.permission.READ_CONTACTS)) {
    ...
    private void initView() {
        ...
        pd = new ProgressDialog(EditYoutubeActivity.this);
        ...
        this.edit_text_upload_youtube=(EditText) findViewById(R.id.edit_text_upload_youtube_video);
        ...
        findViewById(R.id.action_insert_image).setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(EditYoutubeActivity.this);
                builder.setTitle("Insert Image");
                final EditText input = new EditText(EditYoutubeActivity.this);
        ...
        findViewById(R.id.action_insert_link).setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) {
                ...
                final EditText one = new EditText(EditYoutubeActivity.this);
                final EditText two = new EditText(EditYoutubeActivity.this);

                one.setHint("Text");
                two.setHint("URL");

                LinearLayout lay = new LinearLayout(EditYoutubeActivity.this);
    ...
    public boolean save(){
        if (edit_text_upload_title.getText().toString().trim().length()<3){
            Toasty.error(EditYoutubeActivity.this, getResources().getString(R.string.edit_text_upload_title_error), Toast.LENGTH_SHORT).show();
            return true;
        }
        if (!isYoutubeUrl(edit_text_upload_youtube.getText().toString().trim())){
            Toasty.error(EditYoutubeActivity.this, getResources().getString(R.string.edit_text_upload_youtube_error), Toast.LENGTH_SHORT).show();
            return true;
        }
        if (edit_text_upload_description.getHtml() != null){
            if (edit_text_upload_description.getHtml().toString().trim().length()<10){
                Toasty.error(EditYoutubeActivity.this, getResources().getString(R.string.edit_text_upload_description_error), Toast.LENGTH_SHORT).show();
                return true;
            }
        }else{
            Toasty.error(EditYoutubeActivity.this, getResources().getString(R.string.edit_text_upload_description_error), Toast.LENGTH_SHORT).show();
        ...
        call.enqueue(new Callback<List<Category>>() {
            ...
            public void onResponse(Call<List<Category>> call, Response<List<Category>> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    categorySelectAdapter = new CategorySelectAdapter(EditYoutubeActivity.this, categoriesListObj, true, EditYoutubeActivity.this);
        ...
        call.enqueue(new Callback<List<Language>>() {
            ...
            public void onResponse(Call<List<Language>> call, Response<List<Language>> response) {
                if(response.isSuccessful()) {
                    ...
                    ArrayAdapter adapter = new ArrayAdapter(EditYoutubeActivity.this, R.layout.my_spinner_dropdown_item, contactlist);
    ...
    public void upload(){
        ...
        if (imageUrl!=null) {
            ...
            ProgressRequestBody requestFile  = new ProgressRequestBody(file, EditYoutubeActivity.this);
        ...
        Call<ApiResponse> request = service.editYoutube(body,id+"", id_ser, key_ser, edit_text_upload_title.getText().toString().trim(),edit_text_upload_youtube.getText().toString(),edit_text_upload_description.getHtml().toString(),languageList.get(spinner_language_select.getSelectedItemPosition()).getId().toString(),getSelectedCategories());
